...
if($ccuser->authlevel > 0){
	...
	function uploadNewCustomImage($tmpimage,$uploadsDirectory,$filename,$returnData,$returnkey){
	...
	$uploadsDirectory = '../../' . $dirname .'/';
					
	$returnData = uploadNewCustomImage($tmpimage,$uploadsDirectory, $filename, $returnData, 'final');			
